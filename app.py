...
ORDER_DATA = {
    ...
    "Order_ID": "OD336636889712015100",  # [cite: 5]
    "Invoice_Number_Product": "#FAI8FY2600008288",  # [cite: 17]
    "Invoice_Number_Platform": "#FBF3326013240559",  # [cite: 47]
    "Bill_of_Supply_Number": "FAAAQ26013395346",  # [cite: 60]
    "Order_Date": "27-01-2026",  # [cite: 6]
    "Seller_Name": "NAOS SKIN CARE INDIA PRIVATE LIMITED",  # [cite: 2]
    "GSTIN": "29AAECN7906P1ZP",  # [cite: 4]
    
    # Financial Breakdown 
    "Taxable_Value_Product": "₹1,385.60",
    "Taxable_Value_Platform": "₹5.94",
    "SGST_UTGST": "₹124.70",
    "CGST": "₹124.70",
    "GT_Charges": "₹238.00",  # Goods Transport Charges [cite: 81]
    "Platform_Fee": "₹7.00",   # [cite: 46]
    "Grand_Total": "₹1,880.00" # Combined total of all invoice parts
}
